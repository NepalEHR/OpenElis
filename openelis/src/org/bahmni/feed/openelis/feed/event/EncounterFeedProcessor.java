...
public abstract class EncounterFeedProcessor {
    ...
    protected abstract Sample getSample(String sysUserId, Timestamp nowAsSqlDate, OpenMRSEncounter openMRSEncounter, List<OpenMRSOrder> orders);

    private List<SampleTestOrderCollection> getSampleTestCollections(List<OpenMRSOrder> orders, String sysUserId, Timestamp nowAsSqlDate, Sample sample, FeedProcessState processState) {
