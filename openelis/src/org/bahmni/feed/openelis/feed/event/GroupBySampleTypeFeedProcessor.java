...
public class GroupBySampleTypeFeedProcessor extends EncounterFeedProcessor{
    ...
    protected Sample getSample(String sysUserId, Timestamp nowAsSqlDate, OpenMRSEncounter openMRSEncounter, List<OpenMRSOrder> orders) {
        ...
        sample.setEnteredDate(DateUtil.getNowAsTimestamp());
