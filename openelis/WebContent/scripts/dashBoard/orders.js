...
function getColumnsForTodayOrder(alwaysValidate) {
    if (alwaysValidate) {
        return [
            ...
            {id:"collectionDate", name:jQuery("#translatedColumnNames").attr("data-sampleCollectionDate"), field:"sampleCollectionDisplayDate", sortable: true, searchable:true, index: 6, minWidth: 120},
            ...
            {id:"pendingValidationCount", name:jQuery("#translatedColumnNames").attr("data-pendingValidation"), field:"pendingValidationCount", sortable:true, editor:Slick.Editors.Text, index:8, searchable:true, minWidth:160},
...
function getColumnsForBacklogOrder(alwaysValidate) {
    if (alwaysValidate) {
        return [
            ...
            {id:"pendingValidationCount", name:jQuery("#translatedColumnNames").attr("data-pendingValidation"), field:"pendingValidationCount", sortable:true, editor:Slick.Editors.Text, index:8, searchable:false, minWidth:160},
